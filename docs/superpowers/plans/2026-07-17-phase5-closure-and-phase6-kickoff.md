...
```powershell
git add supabase/migrations/0007_weight_days_goal.sql supabase/migrations/0009_burnfit_exercises.sql supabase/migrations/0010_bodyweight_routine_exercises.sql src/lib/workout.ts src/components/crew-latest-workout.tsx "src/components/record/exercise-picker.tsx" "src/app/(tabs)/home/page.tsx" docs/superpowers/plans/2026-07-17-challenge-category-goals.md docs/superpowers/plans/2026-07-17-phase5-closure-and-phase6-kickoff.md PROGRESS.md scripts/rls-test.mjs
```
