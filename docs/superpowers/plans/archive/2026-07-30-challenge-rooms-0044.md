...
**선행 문서:** 설계 `docs/superpowers/specs/2026-07-29-challenge-rooms-design.md` · 인수인계 `docs/superpowers/HANDOFF-2026-07-30-challenge-rooms.md`(**§6 함정 8개를 먼저 읽어라**) · 이전 단계 계획 `docs/superpowers/plans/archive/2026-07-30-challenge-rooms-0042.md`
...
-- 계획: docs/superpowers/plans/archive/2026-07-30-challenge-rooms-0044.md
