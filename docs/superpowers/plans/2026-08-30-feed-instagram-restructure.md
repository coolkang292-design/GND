...
> ⚠️ **구현 결과 2건은 물렸다 (2026-08-31, 사용자 화면 확인).**
> `사진 비율 4/5` → **`4/3` 유지** (*"이전게 더 나은거 같은데 너무 길쭉함"*) ·
> `사진 그리드` → **안 넣음** (*"사진 탭은 필요 없을거 같음"*).
> 나머지(라이트박스·더블탭·액션 행·IntersectionObserver)는 그대로 들어갔다.
