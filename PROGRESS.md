...
## 🔄 2026-08-01 — 맨몸운동 카운팅 + 챌린지 열람 연속일 0054 (DB 적용 ✅ · 개발 서버 확인 ✅ · 배포 ⏳)
...
- **[대기] 운영 배포** — 사용자 승인 후 로컬 `main` 워크트리 복사본에서 `vercel --prod`
- **[대기] 스칼레또 안내 알림** — `scripts/notify-scarlet-bodyweight.mjs` (DRY RUN 확인 완료, `--send`는 배포·폰 확인 후)
