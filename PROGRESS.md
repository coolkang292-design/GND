...
**Phase 7 범위(계획서 §18)**: 아침 09:00 브리핑 크론 · notification_settings UI · 블랙&골드 브랜딩 적용 · 핵심 E2E · Vercel 배포 · 3명 4주 실사용. (5일 소멸 스트릭 표시는 홈 경고 배너로 선반영됨. 브리핑 크론은 배포 환경 필요 → Vercel 배포와 순서 조율)
