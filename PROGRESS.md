...
## ✅ 2026-07-31 — 0051 참가/친구 분리 적용·검증 완료 (배포 전)
...
**남음:** 로그인된 실제 계정으로 로컬 챌린지·홈 화면 확인 → 별도 배포 승인 → **검증한 로컬 `main`에서만** `vercel --prod` → 폰 초대 링크 전 과정 확인. GitHub 푸시나 GitHub 연동 배포는 사용하지 않는다.
