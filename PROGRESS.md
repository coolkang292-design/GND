...
7. **(2026-07-18 추가)** 홈 '최근 친구 활동' 카드(상단)·피드 사진(하단)에 날짜·시간 스탬프 오버레이 표시 — 실기기 확인 중 스탬프 누락 발견 → 공용 `components/photo-stamp.tsx`로 수정 완료

**2026-07-18 결정: 앱 디자인 = 블랙&골드 브랜딩** (GND 로고·불독 마스코트·"NO EXCUSES. JUST RESULTS.") — 계획서 §2 결정 변경으로 기록, 적용(앱 아이콘·manifest·테마 토큰 재스킨)은 Phase 7 항목.
