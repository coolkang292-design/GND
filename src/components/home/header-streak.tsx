 ...
 * 헤더 한 줄 문구.
 *
 * ⚠️⚠️ **2026-08-21 현재 호출부가 없다.** 스트릭은 `personal-today-card.tsx`의
 * `연속` 칸이 말하고 그 카드가 홈의 첫 카드다 — 같은 숫자를 두 줄 위아래로 두 번
 * 적지 않는다(설계 §5). 홈에 되살리기 전에 왜 두 곳에 있어야 하는지를 먼저 적어라.
 * 아래 옛 설명은 2026-08-13~08-20의 배치를 적은 것이다.
 *
 * (옛 설명) 헤더 한 줄 문구 (2026-08-13 사용자 지시 — "스트릭을 맨 위로").
 *
