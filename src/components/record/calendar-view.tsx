                ...
                <div className="rounded-card border border-good/40 bg-good-weak p-3">
                  ...
                  */}
                  ...
                  {/*
                    ...
                    ⚠️ **인터벌은 예외다** (사용자 지시 2026-08-25). `startNow`를
                       그대로 넘기지만 기록 화면이 인터벌 계획에서는 이 값을 쓰지
                       않는다 — 계획한 종목·코스를 채운 인터벌 시트를 열고, 오늘
                       할 시간(4·8·16분)을 고른 뒤 시트에서 시작한다. 계획을 짤
                       때와 몸을 쓰는 때의 컨디션이 달라서 시간은 그날 고른다.
                       (`record/page.tsx`의 `handleLoadPlan` 주석 참조)
                  */}
