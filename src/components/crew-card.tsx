    ...
    <section className="rounded-card border border-line bg-surface p-4 shadow-card">
      ...
      {showDetail && (
        /* 실제 동작을 그대로 적는다 (2026-08-07 사용자 질문):
           ...
           ⚠️ **누가 붙여 주는지까지 적는다** (2026-08-07 사용자 질문). 지금 답은
           **크루장**이다 — `/account`는 이메일이 없는 계정에 연결 폼을 보여주지
           않는다(Supabase 확인 메일 발송 제한, 2026-08-08 실측 429).
           **배치 C에서 카카오·구글 연결이 열리면 이 문장과 `account/page.tsx`를
           같이 고쳐라** (설계 §5.4). "이메일을 연결하세요"까지만 쓰면 할 수 없는
           일을 시키는 문구가 된다. */
